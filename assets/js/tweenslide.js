(function() {
  ...
  function TuinSlider(element, options) {
    ...
    // body
    this.body = document.querySelector(".slider");
  ...
  TuinSlider.prototype.appendPagination = function() {
    var slideTitleElements = document.querySelectorAll(".slide__title");
    var paginationList = "";

    for (var i = 0; i < this.items.length; i++) {
      paginationList += `<li><a data-index=\"' + i + '\" href=\"#' + i + '"\> <span> ${
        slideTitleElements[i].innerHTML
      }</span> </a></li>`;
    }
